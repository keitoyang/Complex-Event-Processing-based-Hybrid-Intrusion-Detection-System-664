 ...
 * @version 1.8
 */
public class Network extends Device implements Serializable{
    ...
    public HashMap<String, HashMap<String, String>> conn_info = new HashMap<>(); //Returns Hashmap of Hashmap E.G: 192.168.0.11={Packets_Received=17, Packets_Sent=6, Connection_Initiator=209.18.47.62, Start_Time=1461042335603, Type_Of_Connection=UDP + Other, End_Time=NA}
                                                                                /* Hashmap Structure:
                                                                                 Key for level one hash-map: The source IP addresses are keys here (e.g. server sending data to client: here server is the source IP and client is the destination IP OR the connection originator)
    ...
    public Network(String DeviceID) {
        super(0, "Tanmay");
        FeaturesCount=0;
    }
