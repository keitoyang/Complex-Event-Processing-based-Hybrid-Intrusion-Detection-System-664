...
public class MCATest1 {
	...
	public static void main(String args[]) throws IOException {
		...
		/*
		 * mca = new MCA(features,features.getRowDimension());
		 * mca.computeTAM();
		 * for(int i=0;i<10;i++) {
		...
		*/
		int i = 0;
		MCA mca = new MCA(features,features.getRowDimension());
		double alpha_vals[] = new double[]{0.5,1.0,1.5,2.0,2.5,3.0};
		...
		int rcount =0;
		for(int jj=0;jj<alpha_vals.length;jj++) {
			mca.setParameters(Double.parseDouble("1.48826747551711E10"),Double.parseDouble("2.3941067504755903E23"),alpha_vals[jj]);
